...
// Entry A limited view of an entry in Kanidm.
type Entry struct {
...
func NewEntry(attrs map[string][]string) *Entry {
	this := Entry{}
	this.Attrs = attrs
	return &this
}
...
func (o *Entry) GetAttrs() map[string][]string {
	if o == nil {
...
func (o *Entry) GetAttrsOk() (map[string][]string, bool) {
	if o == nil {
...
func (o *Entry) SetAttrs(v map[string][]string) {
	o.Attrs = v
}
